  ...
  return (
    <div className="flex-1 space-y-4 p-4 pt-6">
      <div className="flex items-center justify-between space-y-2">
        <h2 className="text-3xl font-bold tracking-tight">Language Editor</h2>
        <Button>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Language Files</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <Search className="h-4 w-4" />
              <Input placeholder="Search language keys..." className="max-w-sm" />
            </div>
            
            <div className="space-y-2">
              <div className="flex items-center justify-between p-3 border rounded">
                <div className="flex-1">
                  <span className="font-mono text-sm">text_home</span>
                </div>
                <div className="flex-1">
                  <Input defaultValue="Home" className="h-8" />
                </div>
              ...
              <div className="flex items-center justify-between p-3 border rounded">
                <div className="flex-1">
                  <span className="font-mono text-sm">text_products</span>
                </div>
                <div className="flex-1">
                  <Input defaultValue="Products" className="h-8" />
                </div>
                <Button variant="outline" size="sm">Save</Button>
              </div>
              ...
              <div className="flex items-center justify-between p-3 border rounded">
                <div className="flex-1">
                  <span className="font-mono text-sm">text_checkout</span>
                </div>
                <div className="flex-1">
                  <Input defaultValue="Checkout" className="h-8" />
                </div>
                <Button variant="outline" size="sm">Save</Button>
              </div>
            </div>
